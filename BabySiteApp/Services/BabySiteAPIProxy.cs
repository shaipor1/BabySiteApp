...
namespace BabySiteApp.Services
{
    class BabySiteAPIProxy
    {
        ...
        private const string DEV_ANDROID_PHYSICAL_URL = "http://192.168.1.14:54152/BabySiteAPI"; //API url when using physucal device on android
        ...
        private const string DEV_ANDROID_PHYSICAL_PHOTOS_URL = "http://192.168.1.14:54152/Images/"; //API url when using physucal device on android
        ...
        private const string DEV_ANDROID_PHYSICAL_DATA_URL = "http://192.168.1.14:54152/data/"; //API url when using physucal device on android
